...
const char *WIFI_SSID = "DIR-842-24G";      // Put here your Wi-Fi SSID
...
const char VAR_ALUNO_DADOS[255] = "alunotest004"; // Put here your Variable label to which data  will be published
