 ...
 * Define Constants
 ****************************************/
const char *UBIDOTS_TOKEN = "BBUS-WzHnqRHBah5T5AjxcZfEftcKgjMhAV";  // Put here your Ubidots TOKEN
const char *WIFI_SSID = "...";      // Put here your Wi-Fi SSID
const char *WIFI_PASS = "...";      // Put here your Wi-Fi password

const char *DEVICE_LABEL = "2023_m4_t10_t7";   // Put here your Device label to which data  will be published
const char VAR_ALUNO_DADOS[255] = "alunotestXXX"; // Put here your Variable label to which data  will be published
const int PUBLISH_FREQUENCY = 180000; // Tempo em cada estação em Milisegundos
unsigned long timer;
